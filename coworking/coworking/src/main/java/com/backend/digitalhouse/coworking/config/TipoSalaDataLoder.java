...
public class TipoSalaDataLoder implements CommandLineRunner {
    ...
    private void cargaTiposSalasIniciales() {
        List<TipoSala> tipoSalasIniciales = Arrays.asList(
                new TipoSala("Vip","Sala exclusiva para equipos de trabajo peqeños", "https://media.istockphoto.com/id/187596796/es/foto/sala-de-estar-vip.jpg?s=612x612&w=0&k=20&c=Xfm-bTuPC6xrkuvAv1lmtFgioybJOzVl3bsC226j2gA="),
